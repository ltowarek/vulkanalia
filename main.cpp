...
int main(int argc, char *argv[]) {
  ...
  //   vka::create_instance(application_info);
  ...
  //       vka::create_graphics_pipeline(*device, *render_pass,
  //       swapchain_extent);

  //   std::vector<vk::UniqueFramebuffer> framebuffers =
  //   vka::create_framebuffers(
  ...
  //   vka::record_command_buffers(*device, command_buffer_pointers,
  //   *render_pass,
  ...
  //       }
  //     }
  //     vka::draw_frame(*device, *swapchain, command_buffer_pointers,
  //     queue_index);
  //   }
